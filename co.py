...
sensor_groups = [
    [sensor_pins[1], sensor_pins[4], sensor_pins[8], sensor_pins[7]],
    [sensor_pins[0], sensor_pins[5], sensor_pins[11], sensor_pins[7]],
    [sensor_pins[3], sensor_pins[2], sensor_pins[11], sensor_pins[10]],
]
...
while True:
    for group in sensor_groups:
        ...
        utime.sleep_ms(2000)  # Tunggu 2 detik antara pengukuran kelompok sensor\
